  ...
  return (
    <div>
      ...
      <div className="address-type-box">
        ...
        <div className="radio-address-select" onChange={(event) =>
                setAddress((prev) => ({ ...prev, addressType: event.target.value}))
              }>
          <div className="home-radio radio-s">
            <input type="radio" value='Home' name="addresstype" id="" />
            <label htmlFor="">Home</label>
          </div>
          <div className="work-radio radio-s">
            <input type="radio" value='Work' name="addresstype" id="" />
            <label htmlFor="">Work</label>
          </div>
          <div className="other-radio radio-s">
            <input type="radio" value='Other' name="addresstype" id="" />
      ...
      <div className="continue-order-btn">
        <button
          onClick={() => {
            setToggle({ orderSumm: true, addressDetails: false });
            submit();
          }}
        >
          Continue
